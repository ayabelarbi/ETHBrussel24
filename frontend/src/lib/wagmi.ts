...
export const config = createConfig({
  chains: [scrollSepolia, zeroNetworktestnet, flareTestnet, morphHolesky, sepolia],
  transports: {
  ...
  connectors: [
    Web3AuthConnectorInstance([zeroNetworktestnet, scrollSepolia, flareTestnet, morphHolesky, sepolia]),
  ]
})